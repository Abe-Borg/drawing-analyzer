...
**Last updated:** 2026-09-24 by the WP-09.1 session (PR to follow).
...
### 2026-09-24 — WP-09.1: section filler and synthesis assurances are not findings (PR to follow)
...
- **Measured first**, as the request asked:
  ...
  - **An instrumented run** of a scratch copy of `origin/main` logging every
    ...
    synthesis extractions in 107 tests, 116 of them with text), the evaluator reproducing the base
    filter exactly. So no option could move a pinned test; the case table
    decided.
