...
- **Added by WP-05.2: the same term again, 4 → 5.** Cross-QC and the anchor now
  ...
  byte-identical inputs. One mechanism again: the term, no key term. The anchor
